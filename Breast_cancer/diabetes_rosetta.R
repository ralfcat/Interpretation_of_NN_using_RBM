...
# Load data
dat <- read.csv("/Users/victorenglof/Documents/GitHub/Interpretation_of_NN_using_RBM/Diabetes/val_set_with_predictions.csv", header = TRUE, colClasses = "character")
...
ros <- rosetta(df, discrete = FALSE, underSample = TRUE, reducer = "Johnson", ruleFiltration = TRUE)
