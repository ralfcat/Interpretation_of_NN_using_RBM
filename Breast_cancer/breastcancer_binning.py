...
path1 = '/Users/victorenglof/Documents/GitHub/Interpretation_of_NN_using_RBM/Breast_cancer/breastcancer_train2_labeled.csv'
path2 = '/Users/victorenglof/Documents/GitHub/Interpretation_of_NN_using_RBM//Breast_cancer/breastcancer_test_labeled.csv'
...
def equal_frequency_binning(dataset1, dataset2, output_path1, output_path2):
    ...
    diagnosis1 = dataset1['diagnosis']
    prediction1 = dataset1['Prediction']
    diagnosis2 = dataset2['diagnosis']
    prediction2 = dataset2['Prediction']
    
    dataset1 = dataset1.drop(columns=['diagnosis', 'Prediction'])
    dataset2 = dataset2.drop(columns=['diagnosis', 'Prediction'])
    ...
    binned_dataset1['diagnosis'] = diagnosis1
    binned_dataset2['diagnosis'] = diagnosis2
...
output_path1 = '/Users/victorenglof/Documents/GitHub/Interpretation_of_NN_using_RBM/Breast_cancer/breastcancer_train2_binned.csv'
output_path2 = '/Users/victorenglof/Documents/GitHub/Interpretation_of_NN_using_RBM/Breast_cancer/breastcancer_test_binned.csv'
