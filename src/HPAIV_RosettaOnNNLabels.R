...
# load data
dat <- read.csv("/Users/victorenglof/Documents/GitHub/True_interpret_nn_rbm/data/NS1/NewTrain2.csv", header = F, colClasses = "character")
...
# load test set
test <- read.csv("/Users/victorenglof/Documents/GitHub/True_interpret_nn_rbm/data/NS1/NewTest.csv", colClasses = "character", header = F)
